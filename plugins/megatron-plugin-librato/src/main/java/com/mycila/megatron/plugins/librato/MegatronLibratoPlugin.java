...
public class MegatronLibratoPlugin extends AbstractMegatronUdpPlugin {
  ...
  public void onNotification(ContextualNotification notification) {
    if (enable) {
      ...
      client.send(formatLine(metric, tags, value, "c"));
    }
  }
    ...
    if (enable) {
      ...
      client.send(statistics.entrySet()
          ...
          .map(entry -> {
            ...
            return formatLine(metric, tags, value, "g");
          })
          .collect(Collectors.toList()));
    }
  }

  private static String formatLine(String metric, String tags, String value, String type) {
