 ...
 */
public class MegatronPrometheusStatsDPluginTest {
  ...
  public void test() throws Exception {
    ...
    try (UdpServer udpServer = new UdpServer(Integer.parseInt(configuration.getProperty("megatron.prometheus.statsd.port")))) {
      try (MegatronTestApi api = new MegatronTestApi(); AbstractMegatronUdpPlugin plugin = new MegatronPrometheusStatsDPlugin()) {
