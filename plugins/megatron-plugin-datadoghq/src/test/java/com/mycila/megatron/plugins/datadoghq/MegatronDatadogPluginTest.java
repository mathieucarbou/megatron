 ...
 */
public class MegatronDatadogPluginTest {
  ...
  public void test() throws Exception {
    ...
    try (UdpServer udpServer = new UdpServer(Integer.parseInt(configuration.getProperty("megatron.datadog.port")))) {
      try (MegatronTestApi api = new MegatronTestApi(); AbstractMegatronUdpPlugin plugin = new MegatronDatadogPlugin()) {
