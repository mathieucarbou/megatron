 ...
 */
public class MegatronStatsDPluginTest {
  ...
  public void test() throws Exception {
    ...
    try (UdpServer udpServer = new UdpServer(Integer.parseInt(configuration.getProperty("megatron.statsd.port")))) {
      try (MegatronTestApi api = new MegatronTestApi(); AbstractMegatronUdpPlugin plugin = new MegatronStatsDPlugin()) {
